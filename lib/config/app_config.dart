...
// Si algunas rutas no usan /api después de la base (ej. https://ea3-api.upc.edu/auth/google),
// podrías tener dos constantes: API_BASE_URL_CON_API y API_BASE_URL_SIN_API.
const String API_BASE_URL = "https://ea3-api.upc.edu/api";

// Ejemplo si necesitaras la URL sin /api al final para alguna cosa específica:
// const String RAW_PROXY_URL = "https://ea3-api.upc.edu";